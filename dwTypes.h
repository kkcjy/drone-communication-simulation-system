#ifndef LIBDW3000_TYPES_H
#define LIBDW3000_TYPES_H
...
typedef struct dwOps_s {
	// Function that activates the chip-select, sends header, read data and disable the chip-select.
	void (*spiRead)(const void *header, size_t headerLength,
                                   	void* data, size_t dataLength);

	// Function that activates the chip-select, sends header, sends data and disable the chip-select.
