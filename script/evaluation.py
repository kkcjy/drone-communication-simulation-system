...
def ranging_plot(ranging1, ranging1_sys_time, ranging2, ranging2_sys_time, ranging3, ranging3_sys_time, vicon, vicon_sys_time, name1="RANGING1", name2="RANGING2", name3="RANGING3"):
    ...
    plt.xlabel('Time (ms)', fontsize=30, labelpad=30) 
    plt.ylabel('Distance Measurement', fontsize=30, labelpad=30)
    plt.title(f'{name1} vs {name2} vs {name3} vs VICON Distance Measurements Over Absolute Time', fontsize=32, pad=40)
